 ...
 * `openai.OpenaiHandler` (native adaptor) unmarshal also uses this envelope. Extra-OK: Jina embeddings `openai.OpenaiHandler` (native adaptor) unmarshal also uses this envelope. Extra-OK: Vertex RequestModeOpenSource `openai.OpenaiHandler` (native adaptor) unmarshal also uses this envelope. Extra-OK: Perplexity `openai.Adaptor.DoResponse` (native adaptor) unmarshal also uses this envelope. Extra-OK: Siliconflow non-rerank `openai.Adaptor.DoResponse` (native adaptor) unmarshal also uses this envelope.
