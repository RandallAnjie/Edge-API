...
export const CHANNEL_TYPE_BAIDU = 15;
...
export const CHANNEL_TYPE_TENCENT = 23;
export const CHANNEL_TYPE_GEMINI = 24;
export const CHANNEL_TYPE_MOONSHOT = 25;
export const CHANNEL_TYPE_ZHIPU_V4 = 26;
export const CHANNEL_TYPE_PERPLEXITY = 27;
export const CHANNEL_TYPE_AWS = 33;
export const CHANNEL_TYPE_COHERE = 34;
export const CHANNEL_TYPE_MINIMAX = 35;
export const CHANNEL_TYPE_DIFY = 37;
export const CHANNEL_TYPE_JINA = 38;
export const CHANNEL_TYPE_CLOUDFLARE = 39;
export const CHANNEL_TYPE_SILICONFLOW = 40;
export const CHANNEL_TYPE_VERTEX = 41;
export const CHANNEL_TYPE_MISTRAL = 42;
export const CHANNEL_TYPE_DEEPSEEK = 43;
export const CHANNEL_TYPE_MOKA = 44;
export const CHANNEL_TYPE_VOLC = 45;
export const CHANNEL_TYPE_BAIDU_V2 = 46;
export const CHANNEL_TYPE_XINFERENCE = 47;
export const CHANNEL_TYPE_XAI = 48;
export const CHANNEL_TYPE_COZE = 49;
export const CHANNEL_TYPE_KLING = 50;
export const CHANNEL_TYPE_JIMENG = 51;
export const CHANNEL_TYPE_VIDU = 52;
export const CHANNEL_TYPE_SUBMODEL = 53;
export const CHANNEL_TYPE_DOUBAO_VIDEO = 54;
export const CHANNEL_TYPE_SORA = 55;
export const CHANNEL_TYPE_REPLICATE = 56;
...
export const MAX_REQUEST_BODY_MB = 128;
