...
CREATE TABLE IF NOT EXISTS users (
  ...
  totp_locked_until INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS mj_tasks (
  ...
  token_id INTEGER NOT NULL DEFAULT 0,
  billing_channel_id INTEGER NOT NULL DEFAULT 0
);
...
const USER_ALTERS = [
  ...
  "ALTER TABLE users ADD COLUMN totp_locked_until INTEGER NOT NULL DEFAULT 0",
  ...
  "ALTER TABLE oauth_providers ADD COLUMN authorization_endpoint TEXT NOT NULL DEFAULT ''",
  "ALTER TABLE oauth_providers ADD COLUMN token_endpoint TEXT NOT NULL DEFAULT ''",
  "ALTER TABLE oauth_providers ADD COLUMN user_info_endpoint TEXT NOT NULL DEFAULT ''",
  "ALTER TABLE oauth_providers ADD COLUMN user_id_field TEXT NOT NULL DEFAULT 'sub'",
  "ALTER TABLE oauth_providers ADD COLUMN username_field TEXT NOT NULL DEFAULT 'preferred_username'",
  "ALTER TABLE oauth_providers ADD COLUMN display_name_field TEXT NOT NULL DEFAULT 'name'",
  "ALTER TABLE oauth_providers ADD COLUMN email_field TEXT NOT NULL DEFAULT 'email'",
  "ALTER TABLE oauth_providers ADD COLUMN well_known TEXT NOT NULL DEFAULT ''",
  "ALTER TABLE oauth_providers ADD COLUMN auth_style INTEGER NOT NULL DEFAULT 0",
  "ALTER TABLE oauth_providers ADD COLUMN access_policy TEXT NOT NULL DEFAULT ''",
  "ALTER TABLE oauth_providers ADD COLUMN access_denied_message TEXT NOT NULL DEFAULT ''",
  "ALTER TABLE oauth_providers ADD COLUMN updated_at INTEGER NOT NULL DEFAULT 0",
  ...
  "ALTER TABLE mj_tasks ADD COLUMN token_id INTEGER NOT NULL DEFAULT 0",
  "ALTER TABLE mj_tasks ADD COLUMN billing_channel_id INTEGER NOT NULL DEFAULT 0",
